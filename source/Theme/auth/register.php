...
<?= $this->start("conteudo") ?>
<section class="container-fluid min-vh-100 d-flex align-items-center justify-content-center bg-klikit-2">
    <div class="row py-md-5 py-3 outer-box">
        <div class="d-block d-md-flex">
            <div class="col-md-6 d-flex align-items-center justify-content-center">
                <div class="login-form border">
                    <h2 class="text-center">Cadastro</h2>
                    <p class="text-center">Já possui conta? <a href="<?= url("auth/login") ?>" class="color-btp-1">Entrar</a></p>
                    <form id="form-login" method="get" action="<?= url("auth/validate-email") ?>">
                        <div class="mb-3">
