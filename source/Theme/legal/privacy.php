...
<section class="container minimum-height avoid-navbar">
    <div class="row d-flex justify-content-center ">
        ...
        <div class="col-12 mt-2 text-justify">
            ...
            <p>Dessa forma, a (nome empresarial), doravante denominada simplesmente como “(nome empresarial simplificado)”, inscrita no CNPJ/MF sob o nº (nº do CNPJ), no papel de Controladora de Dados, obriga-se ao disposto na presente Política de Privacidade.</p>
            
            <p class="h4 py-4">1. Quais dados coletamos sobre você e para qual finalidade?</p>
            ...
            <p class="h5">1.1. Dados pessoais fornecidos pelo titular</p>
            <ul>
                <li>Dado e finalidade</li>
                <li>Dado e finalidade</li>
                <li>Dado e finalidade</li>
                <li>Dado e finalidade</li>
                <li>Dado e finalidade</li>
            </ul>
            <p class="h5">1.2. Dados pessoais coletados automaticamente</p>
            <ul>
                <li>Dado e finalidade</li>
                <li>Dado e finalidade</li>
                <li>Dado e finalidade</li>
            ...
            <p class="h4 py-4">2. Como coletamos os seus dados?</p>
            ...
            <p class="h5 py-2">2.1. Consentimento</p>
            <p>É a partir do seu consentimento que tratamos os seus dados pessoais. O consentimento é a manifestação livre, informada e inequívoca pela qual você autoriza a (nome empresarial simplificado) a tratar seus dados.</p>
            ...
            <p>O seu consentimento será obtido de forma específica para cada finalidade acima descrita, evidenciando o compromisso de transparência e boa-fé da (nome empresarial simplificado) para com seus usuários/clientes, seguindo as regulações legislativas pertinentes.</p>
            <p>Ao utilizar os serviços da (nome empresarial simplificado) e fornecer seus dados pessoais, você está ciente e consentindo com as disposições desta Política de Privacidade, além de conhecer seus direitos e como exercê-los.</p>
            ...
            <p class="h4 py-4">3. Quais são os seus direitos?</p>
            <p>A (nome empresarial simplificado) assegura a seus usuários/clientes seus direitos de titular previstos no artigo 18 da Lei Geral de Proteção de Dados. Dessa forma, você pode, de maneira gratuita e a qualquer tempo:</p>
            <ul>
                <li><span class="color-klikit-2">Confirmar a existência de tratamento de dados</span>, de maneira simplificada ou em formato claro e completo.</li>
                <li><span class="color-klikit-2">Acessar seus dados</span>, podendo solicitá-los em uma cópia legível sob forma impressa ou por meio eletrônico, seguro e idôneo.</li>
                <li><span class="color-klikit-2">Corrigir seus dados</span>, ao solicitar a edição, correção ou atualização destes.</li>
                <li><span class="color-klikit-2">Limitar seus dados quando desnecessários</span>, excessivos ou tratados em desconformidade com a legislação através da anonimização, bloqueio ou eliminação.</li>
                <li><span class="color-klikit-2">Solicitar a portabilidade de seus dados</span>, através de um relatório de dados cadastrais que a (nome empresarial simplificado) trata a seu respeito.</li>
                <li><span class="color-klikit-2">Eliminar seus dados</span> tratados a partir de seu consentimento, exceto nos casos previstos em lei.</li>
                <li><span class="color-klikit-2">Revogar seu consentimento</span>, desautorizando o tratamento de seus dados.</li>
                <li><span class="color-klikit-2">Informar-se sobre a possibilidade de não fornecer seu consentimento</span> e sobre as consequências da negativa.</li>
            </ul>

            <p class="h4 py-4">4. Como você pode exercer seus direitos de titular?</p>
            ...
            <p class="h4 py-4">5. Como e por quanto tempo seus dados serão armazenados?</p>
            <p>Seus dados pessoais coletados pela (nome empresarial simplificado) serão utilizados e armazenados durante o tempo necessário para a prestação do serviço ou para que as finalidades elencadas na presente Política de Privacidade sejam atingidas, considerando os direitos dos titulares dos dados e dos controladores.</p>
            ...
            <p class="h4 py-4">6. O que fazemos para manter seus dados seguros?</p>
            ...
            <p class="h4 py-4">7. Com quem seus dados podem ser compartilhados?</p>

            <p>Tendo em vista a preservação de sua privacidade, a (nome empresarial simplificado) não compartilhará seus dados pessoais com nenhum terceiro não autorizado. </p>
            <p>Seus dados poderão ser compartilhados com nossos parceiros comerciais: (nome completo ou empresarial do parceiro comercial), inscrito no CPF/CNPJ sob o nº (número do CPF Ou CNPJ do parceiro comercial).</p>
            ...
            <p>Política de Privacidade do nosso parceiro: <a class="link-kitlit-2" href="#">(link para a política de privacidade do parceiro comercial).</a></p>
            ...
            <p>III – Proteção dos direitos da (nome empresarial simplificado) em qualquer tipo de conflito, inclusive os de teor judicial.</p>
            <p class="h5 py-2">7.1. Transferência internacional de dados</p>
            ...
            <p>Nesse sentido, a (nome empresarial simplificado) se compromete a sempre adotar eficientes padrões de segurança cibernética e de proteção de dados, nos melhores esforços de garantir e cumprir as exigências legislativas.</p>
            ...
            <p class="h4 py-4">8. Cookies ou dados de navegação</p>
            <p>A (nome empresarial simplificado) faz uso de Cookies, que são arquivos de texto enviados pela plataforma ao seu computador e que nele se armazenam, que contém informações relacionadas à navegação do site. Em suma, os Cookies são utilizados para aprimorar a experiência de uso.</p>
            ...
            <p>A (nome empresarial simplificado) utiliza os seguintes Cookies: <span class="color-klikit-2">(descrição dos tipos de Cookies utilizados pelo site).</span></p>
            ...
            <p>Se você usa o <a class="link-kitlit-2" target="_blank" href="https://support.microsoft.com/pt-br/windows/gerenciar-cookies-no-microsoft-edge-exibir-permitir-bloquear-excluir-e-usar-168dab11-0753-043d-7c16-ede5947fc64d">Internet Explorer</a>.</p>
            <p>Se você usa o <a class="link-kitlit-2" target="_blank" href="https://support.mozilla.org/pt-BR/kb/gerencie-configuracoes-de-armazenamento-local-de-s">Firefox</a>.</p>
            <p>Se você usa o <a class="link-kitlit-2" target="_blank" href="https://support.apple.com/pt-br/guide/safari/sfri11471/mac">Safari</a>.</p>
            <p>Se você usa o <a class="link-kitlit-2" target="_blank" href="https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DDesktop&oco=1&hl=pt-BR">Google Chrome</a>.</p>
            <p>Se você usa o <a class="link-kitlit-2" target="_blank" href="https://support.microsoft.com/pt-br/windows/gerenciar-cookies-no-microsoft-edge-exibir-permitir-bloquear-excluir-e-usar-168dab11-0753-043d-7c16-ede5947fc64d">Microsoft Edge</a>.</p>
            <p>Se você usa o <a class="link-kitlit-2" target="_blank" href="https://help.opera.com/en/latest/web-preferences/#cookies">Opera</a>.</p>
            <p>Você pode ter maiores informações sobre os Cookies que utilizamos e como eles funcionam na nossa Política de Cookies, disponível neste link (link para a Política de Cookies).</p>

            <p class="h4 py-4">9. Alteração desta Política de Privacidade</p>
            <p>A atual versão da Política de Privacidade foi formulada e atualizada pela última vez em: (data da última atualização da Política de Privacidade).</p>
            ...
            <p class="h4 py-4">10. Responsabilidade</p>
            <p>Conforme mencionado no Tópico 6, embora adotemos elevados padrões de segurança a fim de evitar incidentes, não há nenhuma página virtual inteiramente livre de riscos. Nesse sentido, a (nome empresarial simplificado) não se responsabiliza por:</p>
            ...
            <p>II – Ações maliciosas de terceiros, como ataques de hackers, exceto se comprovada conduta culposa ou deliberada da (nome empresarial simplificado).</p>
            ...
            <p>III – Inveracidade das informações inseridas pelo usuário/cliente nos registros necessários para a utilização dos serviços da (nome empresarial simplificado); quaisquer consequências decorrentes de informações falsas ou inseridas de má-fé são de inteiramente responsabilidade do usuário/cliente.</p>

            <p class="h4 py-4">11. Encarregado de Proteção de Dados</p>
            <p>A (nome empresarial simplificado) disponibiliza os seguintes meios para que você possa entrar em contato conosco para exercer seus direitos de titular: (meios de contato).</p>
            ...
            <p>[Nome do Encarregado (CPF do Encarregado)]</p>
            <p>[Email do Encarregado]</p>
