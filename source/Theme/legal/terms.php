...
<section class="container minimum-height avoid-navbar pt-4">
    <div class="row d-flex justify-content-center ">
        ...
        <div class="col-12 mt-2 text-justify">
            ...
            <p class="h4 py-4">1. DA FUNÇÃO DO SITE</p>
            ...
            <p class="h4 py-4">2. DO ACEITE DOS TERMOS</p>
            <p>Este documento, chamado “Termos de Uso”, aplicáveis a todos os visitantes do site, foi desenvolvido por Diego Castro Advogado – OAB/PI 15.613, modificado com permissão para este site.</p>
            ...
            <p class="h4 py-4">3. DO GLOSSÁRIO</p>
            <p>Este termo pode conter algumas palavras específicas que podem não se de conhecimento geral. Entre elas:</p>
            <ul>
                <li><b class="color-klikit-2">VISITANTE:</b> Todo e qualquer usuário do site, de qualquer forma e meio, que acesse através de computador, notebook, tablet, celular ou quaisquer outros meios, o website ou plataforma da empresa.</li>
                <li><b class="color-klikit-2">NAVEGAÇÃO:</b> O ato de visitar páginas e conteúdo do website ou plataforma da empresa.</li>
                <li><b class="color-klikit-2">COOKIES:</b> Pequenos arquivos de textos gerados automaticamente pelo site e transmitido para o navegador do visitante, que servem para melhorar a usabilidade do visitante.</li>
                <li><b class="color-klikit-2">LOGIN:</b> Dados de acesso do visitante ao realizar o cadastro junto a EMPRESA, dividido entre usuário e senha, que dá acesso a funções restritas do site.</li>
                <li><b class="color-klikit-2">HIPERLINKS:</b> São links clicáveis que podem aparecer pelo site ou no conteúdo, que levam para outra página da EMPRESA ou site externo.</li>
                <li><b class="color-klikit-2">OFFLINE:</b> Quando o site ou plataforma se encontra indisponível, não podendo ser acessado externamente por nenhum usuário.</li>
            </ul>
            ...
            <p class="h4 py-4">4. DO ACESSO AO SITE</p>
            ...
            <p class="h4 py-4">5. DA LICENÇA DE USO E CÓPIA</p>
            ...
            <p class="h4 py-4">6. DAS OBRIGAÇÕES<p >
            ...
            <p class="h4 py-4">7. DA MONETIZAÇÃO E PUBLICIDADE</p>
            <p>A EMPRESA pode alugar ou vender espaços publicitários na plataforma, ou no site, diretamente aos anunciantes, ou através de empresas especializadas com o Adsense (Google), Taboola ou outras plataformas especializadas como o Eletro Criticas</p>
            ...
            <p class="h4 py-4">8. DOS TERMOS GERAIS</p>
